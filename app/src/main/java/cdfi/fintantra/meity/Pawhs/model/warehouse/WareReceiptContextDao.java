...
public class WareReceiptContextDao {
    ...
    @SerializedName("list")
    @Expose
    private List<WareHouseListDao> wareHouseListDaoList;
    ...
    public List<WareHouseListDao> getWareHouseListDaoList() {
        return wareHouseListDaoList;
    }

    public void setWareHouseListDaoList(List<WareHouseListDao> wareHouseListDaoList) {
        this.wareHouseListDaoList = wareHouseListDaoList;
    }
}
