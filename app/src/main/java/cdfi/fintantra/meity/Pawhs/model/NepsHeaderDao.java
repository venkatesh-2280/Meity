...
public class NepsHeaderDao {
    ...
    @SerializedName("in_Created_by")
    @Expose
    private String in_Created_by;

    @SerializedName("in_modified_by")
    @Expose
    private String in_modified_by;
    ...
    public void setIn_Estimated_Qty(double in_Estimated_Qty) {
    ...
    public String getIn_modified_by() {
        return in_modified_by;
    }

    public void setIn_modified_by(String in_modified_by) {
        this.in_modified_by = in_modified_by;
    }
}
