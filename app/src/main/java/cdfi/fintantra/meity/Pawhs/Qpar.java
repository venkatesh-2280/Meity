...
public class Qpar extends AppCompatActivity implements View.OnClickListener, QualityEditDeleteListener {
...
protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qpar);
...
public void onClick(View view) {
        ...
        {
        qpname.add(quality);
        db.insertqpar(sid, qualityCode + "-" + quality, editTextActualValue.getText().toString());
        ...
        qpname.add(quality);
        if(spinActValue == 1) {
        db.insertqpar(sid, qualityCode + "-" + quality, "Yes");
        textViewQualityPara.setText("");
        textViewUom.setText("");
        textViewThreshold.setText("");
        editTextActualValue.setText("");
        ...
        {
        db.insertqpar(sid, qualityCode + "-" + quality, "No");
        textViewQualityPara.setText("");
        textViewUom.setText("");
        textViewThreshold.setText("");
        editTextActualValue.setText("");
...
public class MyRecyclerViewAdapterQulaity extends RecyclerView.Adapter<MyRecyclerViewAdapterQulaity.ViewHolder> {
    ...
    @NonNull
    @Override
    public MyRecyclerViewAdapterQulaity.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.custom_recyclerview_quality, parent, false);
        return new MyRecyclerViewAdapterQulaity.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MyRecyclerViewAdapterQulaity.ViewHolder holder, int position) {
    ...
    public  void fetchsn()
    {
        String selectQuery = "SELECT  * FROM qpar where v1 ="+sid;
        qlist.clear();
        qpname.clear();
...
public class MyRecyclerViewAdapterfarmer extends RecyclerView.Adapter<MyRecyclerViewAdapterfarmer.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyRecyclerViewAdapterfarmer.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dbs.delete("qpar", "id" + "=" + pojofar.getId(), null);
                qpname.remove(qpv[1]);
                fetchsn();
