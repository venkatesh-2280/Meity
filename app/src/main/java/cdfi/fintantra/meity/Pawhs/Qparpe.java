...
public class Qparpe extends AppCompatActivity implements View.OnClickListener, QualityEditDeleteListener {
    ...
    Qparpe.MyRecyclerViewAdapterfarmer adapterf;
    boolean isNetwork;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_qparpe);
...
//        }
        ...
        productCode = i.getStringExtra("PC");
        adapterf = new Qparpe.MyRecyclerViewAdapterfarmer(mContext, qlist);
        fetchsn();
                ...
                else
                {
                    ...
                    if(qstatus == 0) {
                        if(editTextActualValue.getText().toString().equalsIgnoreCase("")){
                            ...
                            try {
                                ...
                                {
                                    qpname.add(quality);
                                    db.insertqparpe(ts, qualityCode + "-" + quality, editTextActualValue.getText().toString());
                    ...
                    else
                    {
                        ...
                        else
                        {
                            qpname.add(quality);
                            if(spinActValue == 1) {
                                db.insertqparpe(ts, qualityCode + "-" + quality, "Yes");
                                textViewQualityPara.setText("");
                                textViewUom.setText("");
                                textViewThreshold.setText("");
                                editTextActualValue.setText("");
                            ...
                            {
                                db.insertqparpe(ts, qualityCode + "-" + quality, "No");
                                textViewQualityPara.setText("");
                                textViewUom.setText("");
                                textViewThreshold.setText("");
                                editTextActualValue.setText("");
    ...
    private void showQualityDialog() {
        ...
        final Qparpe.MyRecyclerViewAdapterQulaity adapterf = new Qparpe.MyRecyclerViewAdapterQulaity(mContext, spmDetailDaoList);
    ...
    public class MyRecyclerViewAdapterQulaity extends RecyclerView.Adapter<Qparpe.MyRecyclerViewAdapterQulaity.ViewHolder> {
        ...
        @NonNull
        @Override
        public Qparpe.MyRecyclerViewAdapterQulaity.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = mInflater.inflate(R.layout.custom_recyclerview_quality, parent, false);
            return new Qparpe.MyRecyclerViewAdapterQulaity.ViewHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull Qparpe.MyRecyclerViewAdapterQulaity.ViewHolder holder, int position) {
    ...
    public  void fetchsn()
    {
        String selectQuery = "SELECT  * FROM qparpe where v1 ="+ts;
        qlist.clear();
        qpname.clear();
    ...
    public class MyRecyclerViewAdapterfarmer extends RecyclerView.Adapter<Qparpe.MyRecyclerViewAdapterfarmer.ViewHolder> {
        ...
        @NonNull
        @Override
        public Qparpe.MyRecyclerViewAdapterfarmer.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = mInflater.inflate(R.layout.quality_parameter_list3, parent, false);
            return new Qparpe.MyRecyclerViewAdapterfarmer.ViewHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull Qparpe.MyRecyclerViewAdapterfarmer.ViewHolder holder, int position) {
            ...
            holder.item_delete.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    dbs.delete("qparpe", "id" + "=" + pojofar.getId(), null);
                    qpname.remove(qpv[1]);
                    fetchsn();
