...
public class PmContextDao {
    ...
    public List<PmListDao> getPmListDaoList() {
        return pmListDaoList;
    }

    public void setPmListDaoList(List<PmListDao> pmListDaoList) {
        this.pmListDaoList = pmListDaoList;
    }
}
