...
public class FormerContextDao {
    ...
    public List<FormerDao> getFormerDaoList() {
        return formerDaoList;
    }

    public void setFormerDaoList(List<FormerDao> formerDaoList) {
        this.formerDaoList = formerDaoList;
    }
}
