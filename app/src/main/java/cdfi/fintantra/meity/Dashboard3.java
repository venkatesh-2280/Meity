...
public class Dashboard3 extends AppCompatActivity {
    ImageView nd;
    RelativeLayout rl1, rl2, rl3, r1, r2, r3, r6, rm, trs, rlog;
    ImageView im, im2;
    String mPhoneNumber;
    String fmid;
    JSONObject user3;
...
//
//            editor.putString("phn", mPhoneNumber);
//            editor.putString("uns", "adsfdrm001");
//
//
//
//            editor.commit();
//            Log.e("MOB",""+mPhoneNumber);
//            return;
//        } else {
//            requestPermission();
//        }
        ...
        titleh.setText(sharedpreferences.getString("un",""));
        im.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final ProgressDialog pd = new ProgressDialog(Dashboard3.this);
        ...
        im2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isNetworkAvailable()) {
                    ...
                    pd.setMessage("Loading");
                    pd.show();
                    Intent i = new Intent(getApplicationContext(), MFC.class);
                    SharedPreferences.Editor editor = sharedpreferences.edit();
        ...
        nd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dialog = new Dialog(Dashboard3.this);
                ...
                rlog.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if(isNetworkAvailable()) {
                            RequestQueue queue = Volley.newRequestQueue(Dashboard3.this);
...
// add it to the RequestQueue
                        ...
                        {
                            Toast.makeText(Dashboard3.this, "No Network Available", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                ...
                trs.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (isNetworkAvailable()) {
                            ...
                            if (cc.getCount() == 0) {
                                final AlertDialog alertDialog = new AlertDialog.Builder(Dashboard3.this)
//set icon
                            ...
                            public void onResponse(JSONObject response) {
                                ...
                                try {
                                    ...
                                    for (int j = 0; j < cast.length(); j++) {
                                       ...
                                       // mydb.inserfarlist(n1, n2, n3, "0", n4, n5, n6, n7);
...
//set negative button
                ...
                stringRequest.setRetryPolicy(new DefaultRetryPolicy(
                        ...
                        DefaultRetryPolicy.DEFAULT_MAX_RETRIES,
                        DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
                VolleySingleton.getInstance(Dashboard3.this).addToRequestQueue(stringRequest);
            }
        });
    ...
    public void offlinesave() {
        ...
        try {
            ...
            if (cc.moveToFirst()) {
                ...
                user2.put("in_farmer_dob", cc.getString(6));
                ...
                if (cursora.moveToFirst()) {
                    ...
                    do {
                        ...
                        try {
                            ...
                            ob6.put("in_entity_value", "QCD_UNS_OR");
...
//                        String scd3[] = scd[3].split(":");
                        ...
                        try {
                            ...
                            ob9.put("in_entity_value", cursors.getString(9));
                            ob9.put("in_mode_flag", "I");
                ...
                Cursor cursorla = dbs.query("land", new String[]{"v1","v2","v3","v4","v5","v6","v7","v8","v9","v10","v11"
                        }, "v10" + "=?",
                        new String[]{fn}, null, null, null, null);
