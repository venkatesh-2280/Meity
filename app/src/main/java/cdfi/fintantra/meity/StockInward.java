...
public class StockInward extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stock_inward);
        ...
        view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final Dialog dialog = new Dialog(StockInward.this);
                ...
                recyclerView.setLayoutManager(new LinearLayoutManager(StockInward.this));
                adapter = new MyRecyclerViewAdapter(StockInward.this, animalNames);
